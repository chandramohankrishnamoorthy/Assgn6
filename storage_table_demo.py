...
resourcegroup_name = 'cmk'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'cmk'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
cardealer = Entity()
cardealer.PartitionKey = 'cardealership'
cardealer.RowKey = '008'
cardealer.make = 'Honda'
cardealer.model = 'Civic'
cardealer.year = 2017
